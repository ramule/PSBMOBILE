...
export class ApproveMandateDetailService {
  ...
  /**
   * request parameter for declineMandateRequest
   */
  declineMandateRequest(approveMandateDetail : Mandate,formData) {
    var upiRequestObj = {
      ...
      [this.constant.key_upi_subAction]: this.constant.upiserviceName_REJECTMANDATE,
      [this.constant.key_upi_inputParam]: {
        ...
        [this.constant.key_upi_payerAddr] : approveMandateDetail.payerAddress,
        [this.constant.key_upi_payeeVPA] : approveMandateDetail.payeeAddress,
        [this.constant.key_upi_beneMobileNo] : approveMandateDetail.mobileNo,
        [this.constant.key_upi_isSpam] : formData.spam ? "YES" : 'N',
        [this.constant.key_upi_device]: this.dataService.getDeviceObjectForUpi(),
      }
    }
    console.log("declineMandateRequest  ", JSON.stringify(upiRequestObj));
   ...
   */
  setBlockUPIReq(blockPeriod,mandateDetails) {
    var upiRequestObj = {
      [this.constant.key_upi_entityID]: this.constant.val_upi_psb,
      [this.constant.key_upi_mobileNo]: this.commonMethod.processPhoneNo(this.storage.getLocalStorage(this.constant.storage_mobileNo)),
      [this.constant.key_upi_subAction]: this.constant.upiserviceName_BLOCKNOTIFICATION,
      [this.constant.key_upi_inputParam]: {
        [this.constant.key_upi_paymentAddress]:mandateDetails.payeeAddress,
        [this.constant.key_upi_appVersion]: this.constant.val_upi_app_version,
        [this.constant.key_upi_blockPeriod]:blockPeriod,
        [this.constant.key_upi_nickName]:mandateDetails.payeeName,
        [this.constant.key_upi_entityID]: this.constant.val_upi_psb,
        [this.constant.key_upi_mobileNo]: this.commonMethod.processPhoneNo(this.storage.getLocalStorage(this.constant.storage_mobileNo)),
        [this.constant.key_upi_notificationType]:this.constant.val_upi_TRANSACTION_NOTIFICATION,
        [this.constant.key_upi_language]: this.dataService.getSelectedLanguageCodeUPI(),
        [this.constant.key_upi_device]: this.dataService.getDeviceObjectForUpi(),
        [this.constant.key_upi_txnID]:mandateDetails.txnId
      }
    }
