...
export class UPINotificationService {
  latitude: any;
  longitude: any;
  ...
  getNotificationListRequest() {
    var upiRequestObj = {
      ...
      [this.constant.key_upi_subAction]: this.constant.upiserviceName_GETAPPNOTIFICATION,
    ...
    console.log("getNotificationListRequest ", JSON.stringify(upiRequestObj));
