...
import {ForgotTpinService} from '../forgot-tpin/forgot-tpin.service';
declare var showToastMessage: any;
@Component({
  selector: 'app-forgot-tpin',
  templateUrl: './forgot-tpin.component.html',
  styleUrls: ['./forgot-tpin.component.scss']
})
export class ForgotTpinComponent implements OnInit {
  otpForm: FormGroup;
  ...
  constructor( public DataService: DataService,private router: Router,
   ...
   public loader: pageLoaderService,
    ...
    private forgotTpinService:ForgotTpinService,
) { }
  ...
  getProfileUpdateChangeTPIN()
  {
   ...
   var param=this.forgotTpinService.getProfileUpdateChangeTPINParam(this.otpForm.value)
