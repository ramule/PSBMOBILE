...
export class LoginService {
  ...
  getParamForLoginMPIN(formData) {
    var inputData = {
      ...
      [this.constant.key_MPIN]: this.encryptDecryptService.createMD5Value(formData.mpin),
    }
  ...
  getParamForLogin(formData) {
    var inputData = {
      ...
      [this.constant.key_omniDashData]: "",//000023372 //011170631
    }
    console.log(JSON.stringify(inputData));
