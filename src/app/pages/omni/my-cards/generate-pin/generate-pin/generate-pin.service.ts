...
export class GeneratePinService {
  ...
  getRegenratePinParam(debitCardNo,newPin,expiryDate,type) {
    var inputData = {
      ...
      [this.constant.key_NEWPIN]: newPin,
      [this.constant.key_Expiry]: expiryDate,
    ...
    console.log(' get ', JSON.stringify(inputData));
