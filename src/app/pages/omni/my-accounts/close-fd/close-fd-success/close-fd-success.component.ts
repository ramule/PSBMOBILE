...
@Component({
  selector: 'app-close-fd-success',
  templateUrl: './close-fd-success.component.html',
  styleUrls: ['./close-fd-success.component.scss']
})
export class CloseFDSuccessComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.receiptResp = this.dataService.closeFDObj;
 ...
 */
  getValuesToSend() {
    ...
    // selectedFields += "Depositer Type :" + this.receiptResp.FDAccNumber + ", ";
    // selectedFields += "FD Account Number :" + this.receiptResp.FDAccNumber + ", ";
  ...
  downloadPdfReceipt(type) {
    ...
    // this.receiptCloseFDJson[3].value = this.receiptResp.FDAccNumber ?  this.receiptResp.FDAccNumber : '-';
    // this.receiptCloseFDJson[4].value = this.receiptResp.rateOfInterest ? this.receiptResp.rateOfInterest + '%' : '-';
    // this.receiptCloseFDJson[5].value = this.receiptResp.rateOfInterest ? this.receiptResp.rateOfInterest + '%': '-';
    // this.receiptCloseFDJson[6].value = this.receiptResp.currentMaturityAmount ? '₹ '+ this.receiptResp.currentMaturityAmount : '-';
    // this.receiptCloseFDJson[7].value = this.receiptResp.creditToClose ? '₹ '+ this.receiptResp.creditToClose : '-';
    // this.receiptCloseFDJson[8].value = this.receiptResp.maturityDate ? this.receiptResp.maturityDate : '-';
    // this.receiptCloseFDJson[9].value = this.receiptResp.maturityPayoutAccount ? this.receiptResp.maturityPayoutAccount : '-';
    ...
    // this.generatePDF(imgColor, this.receiptType, this.dataService.receiptmsg, this.refTransJson, this.receiptCloseFDJson, 'Close_FD_Receipt', branchJSON, type, selAccDtl[0].accountNo, this.todayDateTime);
    this.commonMethod.generatePDF(imgColor, this.receiptType, this.dataService.receiptmsg, this.refTransJson, this.receiptCloseFDJson, 'Close_FD_Receipt', branchJSON, type, selAccDtl[0].accountNo, this.todayDateTime);
  }
