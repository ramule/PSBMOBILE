...
export class NomineeDetailsService {
  ...
  getUpdateNomineeService (cifNumber,accountNo, formValue,minorFlag, dateOfBirth){
    ...
    var address = formValue.address2
    var updatedNomineeData = cifNumber + "|" + accountNo + "|" + formValue.nomineeName + "|" + formValue.nomineeRelationship + "|" + formValue.address1 + "|"  + formValue.address2 + "|" + dateOfBirth + "|" +  minorFlag + "|" +
                              formValue.guardianName + "|" + formValue.guardianAddress + "|"  +  mobileNo + "|" + formValue.city + "|"  + formValue.state + "|" + 'IN' ;
    var inputData = {
      [this.constant.key_entityId]: this.constant.getEntityId(),
      [this.constant.key_mobPlatform]: this.constant.val_mobPlatform,
      [this.constant.key_mobileAppVersion]: this.constant.val_mobileAppVersion,
    ...
    console.log("Nominee Request ::", inputData);
