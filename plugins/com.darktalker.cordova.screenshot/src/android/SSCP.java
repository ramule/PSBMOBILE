 ...
 */
package com.darktalker.cordova.sscp;
...
public class SSCP extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, final CallbackContext callbackContext) throws JSONException {
        ...
        if (action.equals("saveScreenshot")) {
            if(PHCP.hasPermission(this, PERMISSIONS[0])) {
                saveScreenshot();
            } else {
              PHCP.requestPermissions(this, SAVE_SCREENSHOT_SEC, PERMISSIONS);
            }
            return true;
