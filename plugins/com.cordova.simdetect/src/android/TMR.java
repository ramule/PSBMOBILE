...
public final class TMR {
  public static boolean isDualMode() {
    try {
      ...
      if ("Philips T939".equals(model)) {
        if (method.invoke((Object)null, new Object[] { "phone0" }) != null && 
          method.invoke((Object)null, new Object[] { "phone1" }) != null)
          return true; 
        return false;
      } 
      if (method.invoke((Object)null, new Object[] { "phone" }) != null) {
        if (method.invoke((Object)null, new Object[] { "phone2" }) != null);
      } else if (method.invoke((Object)null, new Object[] { "telephony.registry" }) != null) {
        if (method.invoke((Object)null, new Object[] { "telephony.registry2" }) != null);
      } else {
        return false;
      } 
      return true;
  ...
  public static String getSubscriberId(int cardIndex) {
    ...
    try {
      ...
      if (param == null && cardIndex == 1)
        param = method.invoke((Object)null, new Object[] { "iphonesubinfo1" }); 
      if (param == null)
        return null; 
  ...
  private static int getSimState(String simState) {
    try {
      ...
      method.setAccessible(true);
      String prop = (String)method.invoke((Object)null, new Object[] { simState });
      if (prop != null)
        prop = prop.split(",")[0]; 
