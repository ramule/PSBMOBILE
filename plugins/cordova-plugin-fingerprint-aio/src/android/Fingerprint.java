...
public class Fingerprint extends CordovaPlugin {
    ...
    private void executeIsAvailable() {
        ...
        if (error != null) {
          ...
          FingerprintManager fingerprintManager = (FingerprintManager) cordova.getActivity().getApplicationContext().getSystemService(Context.FINGERPRINT_SERVICE);
          if (!fingerprintManager.isHardwareDetected()) {
            // Device doesn't support fingerprint authentication
            sendError(PluginError.BIOMETRIC_HARDWARE_NOT_SUPPORTED);
